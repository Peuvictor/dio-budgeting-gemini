...
Receber um comando do usuário;

Processar e interpretar esse comando com IA;

Identificar a intenção;

Executar funções da aplicação;

Registrar ou consultar transações financeiras;

Gerar uma resposta para o usuário.
...
Nunca adicione sua API Key diretamente ao código ou ao repositório Git.
